...
module.exports.run = async function({ api, event }) {
  ...
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    api.sendMessage(`🔴🟠🟡🟢𝖢𝗈𝗇𝗇𝖾𝖼𝗍𝗂𝗇𝗀 𝖠𝗂𝗇𝗓(𝖠𝖨)🔴🟠🟡🟢`, threadID);
    return api.sendMessage(`${global.config.BOTNAME} 🟢𝖢𝗈𝗇𝗇𝖾𝖼𝗍𝖾𝖽 𝖲𝗎𝖼𝖼𝖾𝗌𝗌𝖿𝗎𝗅🟢
𝖳𝗁𝖺𝗇𝗄𝗒𝗈𝗎 𝖿𝗈𝗋 𝗎𝗌𝗂𝗇𝗀 𝖠𝗂𝗇𝗓(𝖠𝖨), 𝖴𝗌𝖾 𝖼𝖺𝗅𝗅𝖺𝖽 𝖼𝗈𝗆𝗆𝖺𝗇𝖽 𝗂𝖿 𝗒𝗈𝗎 𝖾𝗇𝖼𝗈𝗎𝗇𝗍𝖾𝗋 𝗌𝗈𝗆𝖾 𝖾𝗋𝗋𝗈𝗋!\n\n𝖣𝖾𝗏𝖾𝗅𝗈𝗉𝖾𝗋 𝖫𝗂𝗇𝗄: https://facebook.com/berlovesyou`, threadID);
  }
  else {
    try {
    const request = require("request");
